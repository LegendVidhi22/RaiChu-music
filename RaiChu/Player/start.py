...
async def start(_, message: Message):
        ...
        f"""**I ᴀᴍ SOFIA 𝙈𝙪𝙨𝙞𝙘   
ʙᴏᴛ ʜᴀɴᴅʟᴇ ʙʏ [VIDHI](https://t.me/sofiasupport)
Thanks to add me 😇**
        """,
            ...
            [
                [
                    InlineKeyboardButton(
                        "Handle", url="https://t.me/legend_vidhi_vrs"
                    ),
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                       " 𝐒𝐮𝐩𝐩𝐨𝐫𝐭👿", url="https://t.me/sofiasupport"
                    ),
                    InlineKeyboardButton(
                        "𝐔𝐩𝐝𝐚𝐭𝐞𝐬", url="https://t.me/sophiaxsupportchannel"
                    )
                ],[
                    InlineKeyboardButton(
